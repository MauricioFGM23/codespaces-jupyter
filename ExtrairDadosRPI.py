...
def dados_arquivos(caminho_arquivo):
    ...
    dentro_do_bloco = False # Variável para indicar se estamos dentro de um bloco de texto com "(21)"
...
if __name__ == "__main__":
    pasta = "/workspaces/codespaces-jupyter/RPISpider/dist"
    ...
    for arquivo in arquivos:
        ...
        with open(caminho_arquivo, 'r') as file:
            ...
            ultima_palavra = primeira_linha.split()[-1]
            lista_blocos.insert(0,[ultima_palavra])
